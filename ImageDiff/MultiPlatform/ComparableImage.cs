...
//using Tesseract;
//using static ImageDiff.MultiPlatform.Difference;
...
//        public ComparableImage(CompareSettings settings, string imagePath)
//        {
//            Settings = settings;
...
//        public ComparableImage(CompareSettings settings, string imagePath, TesseractEngine engine)
//        {
//            Settings = settings;
//            AreasOfInterest = new List<LayoutBlock>();
//            LoadFromFile(imagePath, engine);
//        }
//        public ComparableImage(CompareSettings settings, byte[] imagePath, TesseractEngine engine)
//        {
//            Settings = settings;
//            AreasOfInterest = new List<LayoutBlock>();
...
//        //    image.Dispose();
//        //}
//        public ComparableImage(CompareSettings settings)
//        {
//            AreasOfInterest = new List<LayoutBlock>();
//            Settings = settings;
//        }
...
//        private Pixel[,] ProcessPixels(Bitmap image)
//        {
...
//                    var pixelColor = new Rgba32(buffer[byteIndex + 2], buffer[byteIndex + 1], buffer[byteIndex]);
//                    RawImageGreyScale[i, widthIndex] = AsGrey(pixelColor);
//                    pixels[i, widthIndex] = new Pixel(pixelColor, i, widthIndex);
//                }
//            }
...
//        public Bitmap CompareTo(ComparableImage baselineImage, out List<Difference> differences)
//        {
...
//        public bool CompareBoundsWithOffset(LayoutBlock thisLocation, LayoutBlock otherLocation, ComparableImage otherImage, Point offest, out double matchWeight)
//        {
...
//            }
//        }
//        public bool CompareBounds(LayoutBlock thisLocation, LayoutBlock otherLocation, ComparableImage otherImage)
//        {
//            //var offset = new Point(thisLocation.Bounds.X1 - otherLocation.Bounds.X1, thisLocation.Bounds.Y1 - otherLocation.Bounds.Y1);
...
//                    var r = Math.Abs(col.R - RawImage[i, j].pixel.R);
//                    var g = Math.Abs(col.G - RawImage[i, j].pixel.G);
//                    var b = Math.Abs(col.B - RawImage[i, j].pixel.B);
